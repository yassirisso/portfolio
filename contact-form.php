                    ...
                    <div class="mx-4 mt-12 text-center user-info lg:mx-6">
                        <a href="index.html"
                            ...
                            <img 
                                ...
                                alt="Yassir Issoughaine"> <!--Image for Dark Version -->
                            <img 
                                src="assets/img/user-sidebar-thumb-light.png" 
                                class="dark:hidden"
                                alt="Yassir Issoughaine"> <!--Image for Light Version -->
                        </a>
                        <h6 class="mb-1 text-lg font-semibold text-black dark:text-white name">Yassir Issoughaine</h6>
                    ...
                    <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                        ...
                        <div class="flex items-center justify-between my-4 space-x-4 skills_circle *:space-y-2 *:text-center">
                            <div class="progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="90" data-circlefill="#00bcbc" data-circleempty="#777777">
                            ...
                            <div class="progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="80" data-circlefill="#00bcbc" data-circleempty="#777777">
